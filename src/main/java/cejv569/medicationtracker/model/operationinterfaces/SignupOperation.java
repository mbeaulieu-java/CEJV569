 ...
 * is used to transfer AccountData type instances containing the minimum account data to be saved to the
...
public interface SignupOperation extends ViewOperation {
     ...
     * to the database layer via an AccountData ViewData subclass data object, to be saved to
     ...
     * @param data AccountData type - data object containing the user account information entered
     ...
     */
    boolean postData(AccountData data) throws UserAlreadyExistsException, OperationFailureException;
}
