...
public class EffectHistoryOperation extends Operation implements cejv569.medicationtracker.model.operationinterfaces.EffectHistoryOperation {

    public EffectHistoryOperation() {
